...
const  size_t nx = 64;        // Attribute (int variable)
const  size_t ny = 64;        // Attribute (int variable)
const  size_t nz = 64;        // Attribute (int variable)
